...
wxPanel( parent, id )
{
	...
	m_notebook->SetPageBitmap(0, AppBitmaps::GetBitmap(wxT("cpp"), AppBitmaps::Size::IconSmall));
	...
	m_notebook->SetPageBitmap(1, AppBitmaps::GetBitmap(wxT("h"), AppBitmaps::Size::IconSmall));
